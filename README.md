# ☀️ Solar Energy Yield Predictor
### 🌐 Project Portal & Operational Directory

Welcome to the interactive landing page for the Solar Energy Yield Predictor system. Below is a structured navigation layout to explore our system components, notebooks, and scripts without altering calculation execution paths.

---

## 📂 System Directory Matrix
*Click on any component below to jump directly to the code notebook, source script, or document.*
  ...
  <tr>
    <td width="33%" valign="top">
      ...
      <ul>
        ...
        <li><a href="Visualization.ipynb">UI Plot Generation</a></li>
    ...
    <td width="33%" valign="top">
      ...
      <ul>
        <li><a href="Model.ipynb">XGBoost Training Workspace</a></li>
        <li><a href="physicsCalc.py">Physics Calculation Engine</a></li>
        <li><a href="pipeline_functions.py">Data Pipeline Streams</a></li>
        <li><a href="physicsutil.py">Math & Geometry Helpers</a></li>
        <li><a href="Model_Cells_Explanations.pdf">System Explanations (PDF)</a></li>
        <li><a href="solar_gap_model.joblib">Model Weight Artifacts</a></li>
      </ul>
    </td>
    <td width="33%" valign="top">
      ...
      <ul>
        ...
        <li><a href="solarapp.py">Alternative Dashboard UI</a></li>
...
## 🚀 Quick Launch Assets
* **🔗 Live Streamlit Web Application:** [Launch Dashboard Demo](https://streamlit.app)
* **⚙️ Installation Dependencies:** [View requirements.txt](requirements.txt)
* **🗒️ Maintenance Blueprint:** [Read deployment_notes.md](deployment_notes.md)
